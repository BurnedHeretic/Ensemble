    ...
    public partial class MainWindow
    {
            ...
            int playerNumber)
        {
            ...
            if (start == null)
            {
                MessageBox.Show(
                    this,
                    $"P{playerNumber} has no editable skirmish Position entry in the current scenario.\n\n" +
            ...
            // Prevent two editor start slots from occupying the same base.
            ...
            if (occupiedBy != null)
            {
                ...
                MessageBox.Show(
                    this,
                    $"This base is already being used by P{occupiedSlot}.",
            ...
            // Halo Wars skirmish Positions are grouped by Number 1 / 2;
            // Player remains -1. P1..P6 are editor slot labels only.
            start.Player =
                -1;

            start.Number =
                GetStartGroupNumberV363(
                    playerNumber,
                    playerCount);
