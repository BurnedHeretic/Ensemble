...
namespace Ensemble
{
    ...
    public partial class MainWindow
    {
            ...
            int playerNumber)
        {
            ...
            StatusText.Text =
                $"Moved P{moving.Number} to P{anchor.Number}'s position; " +
                $"P{anchor.Number} moved to P{moving.Number}'s previous position.";
        }
            ...
            IScenarioHistoryAction
        {
            ...
            public string Description =>
                $"Swap P{_moving.Number} and P{_anchor.Number} starts";
