...
namespace Ensemble.Services
{
    ...
    /// while the creator positions / rotates / scales the Reach environment.
    ...
    internal static class HaloBspChunkService
    {
        internal sealed class Chunk
        {
            ...
            /// <summary>
            /// Offset from the original BSP object's local origin to this
            /// chunk's local origin, after the currently committed uniform
            /// custom-mesh scale has been applied.
            /// </summary>
